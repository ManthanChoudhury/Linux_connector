        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: ListBody(
              children: <Widget>[
                Text(
                    "1) Open Side Drawer to see History and to see output of any command in history Click on it\n"),
                Text(
                    "2) Default IP is 127.0.0.1, to change the IP of Linux Host Press button behind help\n"),
                Text(
                    "3) Not Liking Light Theme, Turn on dark Mode in you mobile"),
              ],
            ),
          ),
          actions: <Widget>[
